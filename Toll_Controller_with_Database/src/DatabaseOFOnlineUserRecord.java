...
public class DatabaseOFOnlineUserRecord extends JFrame implements ActionListener {
    ...
    public DatabaseOFOnlineUserRecord() {
        ...
        //heading
        JLabel heading = new JLabel("Online User Data");
        add(heading);
        heading.setBounds(600, 10, 500, 50);
        ...
        try {
            ...
            ResultSet AllEmployeeData = c.s.executeQuery("select * from userregistration");
       ...
       /* JLabel EmployeeSearch = new JLabel("Search by License Number:");
        ...
        try {
            ...
            while(AllEmployeeData.next()){
                LicenseNumber.add(AllEmployeeData.getString("License_Number")); //find by id employeeID
            }
    ...
    public void actionPerformed (ActionEvent ae) {
      ...
      /*  if(ae.getSource() == SearchButton){
            //setVisible(false);
            String EmployeeSearchQuary = " select * from userregistration where License_Number = '"+ LicenseNumber.getSelectedItem()+"'";
